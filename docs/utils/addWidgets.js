...
function plugin(hook, vm) {
    ...
    let initializeWidgetSpan = function (el) {
        ...
        el.style.top = (addWidgetsOptions.top + 35 * (widgets.indexOf(el) + 3)).toString() + 'px'
    }
    ...
    let initSwitchMode = function () {
        ...
        widgets.push(switchSpan)
        initializeWidgetSpan(switchSpan)
    ...
    let initColorPicker = function () {
        ...
        widgets.push(colorPickerSpan)
        initializeWidgetSpan(colorPickerSpan)
    ...
    let initCommentScroll = function () {
        scrollToCommentSpan = document.createElement('span')
        scrollToCommentSpan.id = 'scrollToCommentSpan'
        widgets.push(scrollToCommentSpan)
        initializeWidgetSpan(scrollToCommentSpan)
    ...
    let initSakuraRain = function () {
        ...
        showSakuraSpan = document.createElement('span')
        showSakuraSpan.id = 'showSakuraSpan'

        widgets.push(showSakuraSpan)
        initializeWidgetSpan(showSakuraSpan)
    ...
    let initLive2d = function () {
        showLive2dSpan = document.createElement('span')
        showLive2dSpan.id = 'showLive2dSpan'
        widgets.push(showLive2dSpan)
        initializeWidgetSpan(showLive2dSpan)
    ...
    let initShowWidgets = function () {
        showWidgetsSpan = document.createElement('span')
        showWidgetsSpan.id = 'showWidgetsSpan'

        widgets.push(showWidgetsSpan)
        initializeWidgetSpan(showWidgetsSpan)
    ...
    let initScrollToTop = function () {
        ...
        scrollToTopSpan.id = 'scrollToTopSpan'
        scrollToTopSpan.className = 'scroll-to-top'
        widgets.push(scrollToTopSpan)
